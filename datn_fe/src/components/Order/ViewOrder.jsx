...
const ViewOrder = (props) => {
    ...
    const handlePurchase = async () => {
        ...
        const productNames = carts.map(cartItem => cartItem.detail.name).join(', ');
        ...
        carts.forEach(cartItem => {
            ...
            console.log(`Sản phẩm: ${productName}, Thương hiệu hoạt động: ${isBrandActive}, Danh mục hoạt động: ${isCategoryActive}`);
